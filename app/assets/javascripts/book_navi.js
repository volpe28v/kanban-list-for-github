    ...
    for(var i = 0; i < book_infos.length; i++ ){
      ...
      lists += '<li class="book_item" data-book_name="' + book_infos[i].name + '">' +
                 '<a href="#" data-book_id="' + book_infos[i].id + '">' +
                   '<table width="100%">' +
                     '<tr>' +
                       '<td style="text-align: left; word-break: break-all;">' + book_infos[i].name + '</td><td style="text-align: right;"><span class="' + active_counts_class + '" >' + active_todo_counts + '</span></td>' +
                     '</tr>' +
                   '</table>' +
                 '</a>' +
               '</li>';
